...
<body>
	...
	<nav class="cd-secondary-nav">
		...
		<!-- On demande les infos nécessaires à la création d'un compte !-->
			...
			<div>
				<label for="first_name">Prénom : <span class="asterisque">*</span></label>
			...
			<div>
				<label for="password">Mot de passe : <span class="asterisque">*</span></label>
				<input class="required champ one_line" type="password" name="password" value="" required><br><br>
			</div>

			<div>
				<label for="conf_password">Confirmation du mot de passe : <span class="asterisque">*</span></label>
			...
			<div>
				...
				<label for="host">Je souhaite héberger des personnnes sinistrées par une catastrophe naturelle ou industrielle.</label><br><br><br>
			</div>
			...
			<div>
				...
				<label for="remember_me">Se souvenir de moi</label><br><br><br>
			</div>
