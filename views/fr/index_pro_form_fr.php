...
<html>
	...
	<body>
		...
		<p>Les champs précédés d'un astérisque sont obligatoires.</p><br><br>

		<form action="action_form_part.php" method="GET">

			<!-- L'utilisateur doit enter le nom de la société pour laquelle il travaille !-->
			<div>
				<label for="organisation_name">Nom de votre société : <span class="asterisque">*</span></label>
				<input class="required champ" type="text" name="organisation_name" value="" required><br><br>
			</div>

			<!-- On demande à l'utilisateur le secteur de la société pour laquelle il travaille !-->
			<div>
				<label for="operational_area">Secteur d'activité de votre société : <span class="asterisque">*</span></label><br>
			...
			<div>
				<label for="registration_request">Les raisons pour lesquelles je souhaite m'inscrire : <span class="asterisque">*</span></label><br>
				<textarea class="required champ" style="width: 500px; height: 150px;" name="registration_request" placeholder="Expliquez-nous pourquoi vous souhaitez vous inscrire en tant que professionnel sur notre site ALERTE PARIS" required></textarea>
			</div><br><br>

			<!-- On demande à l'utilisateur les coordonnées de sa société !-->
			<div>
				<label for="address">Adresse de votre société : <span class="asterisque">*</span></label>
				<input class="required champ one_line" type="text" name="address" value="" required><br><br>
			</div>

			<div>
				<label for="province">Code Postal : <span class="asterisque">*</span></label>
			...
			<div>
				<label for="country">Pays : <span class="asterisque">*</span></label>
				<select class="required champ">
					<option value="select" label="Veuillez sélectionner votre pays"></option>
			...
			<div>
				<label for="mobile_phone">Téléphone portable : <span class="asterisque">*</span></label>
				<input class="required champ one_line" type="number" name="mobile_phone" value="" required><br><br>
			</div>

			<div>
				<label for="home_phone">Téléphone professionnel : </label>
				<input class="champ one_line" type="number" name="home_phone" value=""><br><br>
			</div>

			<!-- On précise à l'utilisateur que nous allons procéder à une vérification avant la validation de son inscription !-->
			<div>
				<label>Vos identifiants vous seront envoyés après validation de votre inscription.</label>
