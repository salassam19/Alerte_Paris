...
<html>
	...
	<body>
		...
		<form action="action_form_part.php" method="GET">
			...
			<div>
				<label for="organisation_name">Name of organisation : <span class="asterisque">*</span></label>
			...
			<div>
				<label for="operational_area">Operational area : <span class="asterisque">*</span></label><br>
			...
			<div>
				<label for="registration_request">Rational registration request : <span class="asterisque">*</span></label><br>
				<textarea class="required champ" style="width: 500px; height: 150px;" name="registration_request" placeholder="Please tell us why you ask access to ALERTE PARIS..." required></textarea>
			</div><br><br>
			...
			<div>
				<label for="province">Province/State : <span class="asterisque">*</span></label>
			...
			<div>
				<label for="home_phone">Business phone : </label>
			...
			<div>
				<label><strong>Your login details will be sent to the email address you specify, once your registration has been received and approved by our service.</strong></label><br><br>
