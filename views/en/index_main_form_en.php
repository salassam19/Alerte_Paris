...
<html>
	...
	<body>
		...
		<!-- On demande les infos nécessaires à la création d'un compte !-->
			<div>
				<label for="last_name">Last Name : <span class="asterisque">*</span></label>
				<input class="required champ one_line"  type="text" name="last_name" value="" required><br><br>
			</div>

			<div>
				<label for="first_name">First Name : <span class="asterisque">*</span></label>
			...
			<div>
				<label for="country">Country : <span class="asterisque">*</span></label>
				<select class="required champ">
					<option value="select" label="Please select your country"></option>
			...
			<!-- On demande à l'utilisateur les infos son id (adresse email) et son mot de passe !-->
			<div>
				<label for="email">Email : <span class="asterisque">*</span></label>
				<input class="required champ one_line email" type="email" name="email" value="" required><br><br>
			</div>

			<div>
				<label for="password">Password : <span class="asterisque">*</span></label>
				<input class="required champ one_line" type="password" name="password" value="" required><br><br>
			</div>

			<div>
				<label for="conf_password">Please confirm your password: <span class="asterisque">*</span></label>
				<input class="required one_line" type="password" name="conf_password" value="" required><br><br><br>
			</div>

			<!-- On demande à l'utilisateur s'il souhaite héberger des personnes sinistrées !-->
			<div>
				<input type="checkbox" name="host">
				<label for="host">I would like to host people affected by natural or industrial disaster.</label><br><br><br>
			</div>

			<!-- Le choix fait par l'utilisateur le dirigera vers le formulaire correspondant (particulier ou professionnel) !-->
			<div>
				<p>I am : </p>
				<input type="radio" name="individual"><label> A private user</label><br>
				<input type="radio" name="pro_and_indiv"><label> A professionnal user</label><br><br><br><br>
			</div> 

			<!-- Checkbox à cocher pour que l'utilisateur n'ai pas à introduire à chaque connexion son id et son password !-->
			<div>
				<input type="checkbox" name="remember_me">
				<label for="remember_me">Remember me</label><br><br><br>
			</div>
